...
class OpticsPairs:
    ...
    def __init__(self, data: pd.DataFrame):
        ...
        self.cluster_labels_ = None  # Array of cluster labels for securities
    ...
    def reduce_PCA(self,
        ...
        pipe = Pipeline([
            ...
            ('scaler', Scaler),
            # Calculate correlation matrix of scaled data
            ('calc_corr', FunctionTransformer(lambda x: np.corrcoef(x.T))),
    ...
    def calc_eg_norm_spreads(self):
        ...
        for pair in self.pairs:
            ...
            test_1 = ts.coint(security_0, security_1)
            test_2 = ts.coint(security_1, security_0)

            t_stat_1, t_stat_2 = test_1[0], test_2[0]
            pvalue_1, pvalue_2 = test_1[1], test_2[1]
            ...
            # calculate spread
            if abs(t_stat_1) < abs(t_stat_2):
                engle_granger_tests.append(pvalue_2)

                X = sm.add_constant(np.asarray(security_1))
                Y = np.asarray(security_0)

            else:
                engle_granger_tests.append(pvalue_1)
    ...
    def plot_clusters(self, n_dimensions: int = 2):
        ...
        for i in [self.n_components_, self.components_, self.cluster_labels_]:
            if i is None:
                raise ValueError("Required: \n 1. n_components \n 2. \
                                reduced_returns")
        ...
        if n_dimensions == 2:
            ...
            axs.scatter(self.components_[0],
                        self.components_[1],
